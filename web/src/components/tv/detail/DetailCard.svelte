...
<div class="overlay fixed top-0 left-0 h-full w-full p-10 flex items-center justify-center">
  <div class="card p-10 flex overflow-hidden bg-gray-800 text-gray-100">
    <div class="relative" style="width: 34rem; height: 20rem;">
      <div
    ...
    <div class="details ml-20 flex flex-col">
      ...
      <div class="mt-auto flex justify-around">
        <CircleButton><i class="fas fa-play fa-2x"></i></CircleButton>
        <CircleButton><i class="fas fa-times fa-2x"></i></CircleButton>
      </div>
